...
if __name__ == '__main__':
    ...
    parser.add_argument('--resource_path', type=str, required=True, help='Resource path for the simulation')
    parser.add_argument('--solution_name', type=str, required=True, help='Solution name')
    parser.add_argument('--simulation_name', type=str, required=True, help='Simulation name')
    ...
    crm = Simulation(args.resource_path, args.solution_name, args.simulation_name, args.process_group_config)
